...
CREATE UNIQUE NONCLUSTERED INDEX [IDX_RuleType_Name_Enabled] ON [dbo].[RuleProfile]
(
	[Name] ASC,
	[Enabled] ASC
)
...
CREATE TABLE [dbo].[RuleProfile](
	...
	[Name] [varchar](50) NOT NULL,
	[CreateByUserID] [int] NOT NULL,
	[CreateDate] [datetime] NOT NULL CONSTRAINT [DF_RuleProfile_CreateDate]  DEFAULT (getutcdate()),
	[Enabled] [bit] NOT NULL CONSTRAINT [DF_RuleProfile_Enabled]  DEFAULT ((1)),
	[ModifyByUserID] [int] NULL,
	[ModifyDate] [datetime] NULL
    )
GO
...
CREATE TABLE [dbo].[RuleGroup](
	...
	[DisplayOrder] [int] NOT NULL,
	[CreateByUserID] [int] NOT NULL,
	[CreateDate] [datetime] NOT NULL CONSTRAINT [DF_RuleGroup_CreateDate]  DEFAULT (getutcdate()),
	[Enabled] [bit] NOT NULL CONSTRAINT [DF_RuleGroup_Enabled]  DEFAULT ((1)),
	[ModifyByUserID] [int] NULL,
	[ModifyDate] [datetime] NULL
    )
GO
